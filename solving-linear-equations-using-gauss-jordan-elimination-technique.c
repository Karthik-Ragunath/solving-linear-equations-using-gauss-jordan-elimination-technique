# solving-linear-equations-using-gauss-jordan-elimination-technique
the code in this repository is used to solve linear equatiions using gauss jordon elimination technique. this code is written in C language.
